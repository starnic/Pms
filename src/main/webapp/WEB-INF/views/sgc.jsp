		...
		<div class="row">
			...
			<div class="col-xs-3">
				<ul class="nav nav-pills nav-stacked list-group" role="tablist">
					...
					<li role="presentation" class="active"><a href="#">保卫绿化</a></li>
				...
				<div class="tab-content">
						<div>
							...
							<ul class="nav nav-pills nav-justified" role="tablist">
								<li role="presentation"><a href="${APP_PATH }/inspection">巡查管理</a></li>
								<li role="presentation" class="active"><a href="#">保安/保洁管理</a></li>
							</ul>
							<!-- Tab panes -->
							<div class="tab-content">
									<%@ include file="sgcList.jsp"%>
							</div>
						</div>
					</div>
				</div>
