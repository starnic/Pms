...
<link href="${APP_PATH }/static/Bootstrap/css/bootstrap.min.css"
	rel="stylesheet">
<link href="${APP_PATH }/static/cstyle.css"
rel="stylesheet">
...
<body>
	...
	<div class="container-fluid">
									...
									<div class="form-group row">
										<div class="col-sm-1 col-sm-offset-4">
											<button type="button" class=" btn btn-success"
												id="custom_update_butn">修改</button>
										</div>
		...
		<script type="text/javascript">
			var aid, pwd;
			$(function() {
				aid = ${sessionScope.LOGIN_CUSTOM.id};
				getCustom();
			});
			...
			$("#oldpwd").change(function() {
				...
				if (pwd != oldpwd) {
					show_validate_msg("#oldpwd", "error", "密码错误");
					$("#custom_save_butn").attr("ajax-vaa", "aerror");
				} else {
					show_validate_msg("#oldpwd", "success", "密码正确");
					$("#custom_save_butn").attr("ajax-vaa", "asuccess");
				}
			});
